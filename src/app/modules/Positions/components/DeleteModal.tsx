...
export const DeleteModal: React.FC = () => {
    ...
    const handleCloseDelete = () => {
        dispatch(positionsActions.closeDeleteModal())
    }

    const handleDeleteCategory = () => {
        dispatch(positionsActions.deletePosition(deletePosition.id))
    }
    ...
    return (
        <Dialog open={openDelete} onClose={handleCloseDelete}>
            ...
            <DialogContent>
                <DialogContentText>{`Вы уверены, что хотите удалить такую должность, как ${deletePosition.label}?`}</DialogContentText>
            </DialogContent>
