...
import { IDocumentResultsState, IResultFilter } from './types'

export const resultsAdapter = createEntityAdapter<IUser>()

const slice = createSlice({
    name: 'documentResults',
    initialState: resultsAdapter.getInitialState<IDocumentResultsState>({
        ids: [],
        entities: {},
...
export const { actions: documentResultsActions, reducer: documentResultsReducer } = slice
